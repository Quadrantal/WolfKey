...
SECRET_KEY = 'django-insecure-qh#pbjb^9=kg5862d1+9o-r2n--r1^0)9vxev-91f$dze+(m0k'
...
DJANGO_DRF_FILEPOND_FILE_STORE_PATH = os.path.join(BASE_DIR, 'filepond-temp-uploads')
